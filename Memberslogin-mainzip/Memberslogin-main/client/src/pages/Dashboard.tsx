  ...
  return (
    ...
    >
      ...
      >
        <Button
          size="sm"
          className="text-cyan-200 hover:text-cyan-100 text-xs backdrop-blur-md border-cyan-400/60 hover:border-cyan-300/80 bg-cyan-500/10 hover:bg-cyan-500/20 transition-all duration-300 font-bold tracking-wider"
          style={{
        ...
        <Link href="/app/nutrition">
          <Card className="bg-card/40 border-primary/20 p-6 relative overflow-hidden group cursor-pointer hover:border-primary/50 transition-all neon-card">
            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                <p className="text-muted-foreground text-xs uppercase tracking-widest mb-1">
                  Fuel Tracker - Synced with Macro Calculator
                </p>
                <h3 className="text-2xl font-display font-bold text-white group-hover:text-primary transition-colors flex items-center gap-2">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="bg-card/40 border-white/5 p-6 relative overflow-hidden">
            ...
            <h3 className="text-2xl font-display font-bold text-primary">
              {userWeight > (user?.goalWeight || 100) ? "Losing" : "Gaining"}
            </h3>
            <p className="text-xs text-muted-foreground mt-2">
              {Math.abs(
                (userWeight - (user?.startingWeight || 100)) * 1
              ).toFixed(1)} kg from start
            </p>
          </Card>
        </div>
