...
const darel_customDetailedPlans: DetailedPlan[] = [
  {
    ...
    days: [
      {
       day_number: 1,
      day_name: "Day 1",
      focus: "Walking + Full Body Basics",
      is_rest_day: false,
      exercises: [
        { name: "Bodyweight Squats", sets: 2, reps: "12", rest: "60 sec" },
        { name: "Wall Push-Ups", sets: 2, reps: "10", rest: "60 sec" },
        { name: "Standing Shoulder Rolls", sets: 2, reps: "10", rest: "45 sec" },
        { name: "Brisk Walking", sets: 1, reps: "30 minutes" },
      ],
    },
    {
      day_number: 2,
      ...
      exercises: [
        {
          name: "Brisk Walking (Outdoor / Treadmill)",
          sets: 1,
          reps: "40–45 minutes",
        },
      ],
    },
    {
      day_number: 3,
      day_name: "Day 3",
      focus: "Full Body Strength (Beginner)",
      is_rest_day: false,
      exercises: [
        { name: "Chair Squats", sets: 2, reps: "12", rest: "60 sec" },
        {
          name: "Incline Push-Ups (Wall/Table)",
          sets: 2,
          reps: "10",
          rest: "60 sec",
        },
        {
          name: "Bent-Over Backpack Rows",
          sets: 2,
          reps: "12",
          rest: "60 sec",
        },
        {
          name: "Standing Shoulder Press (Water Bottles)",
          sets: 2,
          reps: "12",
          rest: "60 sec",
        },
    ...
    },
    {
      ...
      is_rest_day: false,
      exercises: [
        { name: "Brisk Walking", sets: 1, reps: "30–35 minutes" },
        { name: "Mobility & Stretching", sets: 1, reps: "10–15 minutes" },
      ],
    },
    {
      day_number: 5,
      day_name: "Day 5",
      focus: "Walking + Light Core",
      is_rest_day: false,
      exercises: [
        {
...
const DAREL_CUSTOM_PLAN: PlanGroup = {
  name: "Darel Raj Fat Loss Plan",
  level: "Coach Assigned",
  description:
    "Personalized fat loss plan focused on belly fat reduction, muscle retention, and long-term health.",
  days: [
    {
     day_number: 1,
      day_name: "Day 1",
