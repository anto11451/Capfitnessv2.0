...
price: "₹799",
period: "/ one-time",
description: "A personalized nutrition plan designed around your goals, lifestyle, and food preferences.",
features: [
"Customized diet plan",
"Calorie & macro targets",
"Supplement guidance",
"Food alternatives & substitutions",
"1 plan revision within 7 days",
],
bestFor: [
"Fat loss goals",
"Muscle gain goals",
...
ctaText: "👉 Get My Diet Plan",
},

{
name: "Custom Transformation Pack",
price: "₹1199",
period: "/ one-time",
description: "Complete fitness blueprint with both diet and workout plans tailored to your goals.",
features: [
"Customized diet plan",
...
"Anyone wanting a complete roadmap",
],
popular: true,
icon: Crown,
...
price: "₹1999",
period: "/ month",
description: "Monthly coaching with accountability, progress tracking, and ongoing support.",
features: [
"Customized diet plan",
...
"Progress tracking",
"1 plan adjustment per month",
"Form check assistance",
],
bestFor: [
"Busy professionals",
"People needing accountability",
"Consistent fat loss & muscle gain",
],
popular: false,
icon: Rocket,
gradient: "from-purple-500/20 to-pink-500/20",
borderColor: "border-purple-500/30",
ctaText: "👉 Join Premium Coaching",
},

{
name: "Elite Transformation Coaching",
price: "₹3999",
period: "/ month",
description: "High-touch coaching with priority support, video analysis, and personalized guidance.",
features: [
"Everything in Premium Coaching",
"Unlimited plan adjustments",
"Priority WhatsApp support",
"Video form analysis",
"1-on-1 consultation calls",
"Meal review support",
"Travel & restaurant guidance",
