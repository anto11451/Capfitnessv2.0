  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-32 h-32 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center mb-8 p-2"
      >
        <img src={capLogo} alt="Cap's Fitness" className="w-24 h-24 object-contain" />
      </motion.div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <Button
          onClick={() => setLocation("/app/posture")}
          size="lg"
          variant="outline"
          className="text-lg px-12 py-6 rounded-full"
        >
          🎯 Workout with Posture
        </Button>
      </div>
    </motion.div>
  );
